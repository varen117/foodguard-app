...
import {useUserCases, useUserStats} from '@/hooks/useDatabase';
import {CaseInfo, CaseStatus, RiskLevel} from "@/constants";
        ...
        return (
            <div className="main-container py-12">
                <div className="max-w-4xl mx-auto text-center">
                    <div
                        className="inline-block w-8 h-8 border-4 border-emerald-600 border-t-transparent rounded-full animate-spin"></div>
                            ...
                            {participatedCases.length > 0 ? (
                                <div className="space-y-4">
                                    {participatedCases.map((caseInfo) => (
                                        <div key={Number(caseInfo.caseId)}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => editing && setEditForm({
                                                ...editForm,
                                                name: e.target.value
                                            })}
                                            disabled={!editing}
